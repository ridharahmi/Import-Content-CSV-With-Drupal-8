...
/**
 * @file
 * Contains \Drupal\import_csv\Form\ImportForm.
 */
...
class ImportForm extends FormBase
{
    ...
    public function submitForm(array &$form, FormStateInterface $form_state)
    {
        ...
        foreach ($data as $row) {
            ...
            $operations[] = ['\Drupal\import_csv\addImportContent::addImportContentItem', [$row]];
        }
        //dsm($data);
        $batch = array(
            ...
            'finished' => '\Drupal\import_csv\addImportContent::addImportContentItemCallback',
        );
        batch_set($batch);
    }
